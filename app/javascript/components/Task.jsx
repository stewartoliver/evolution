...
const Task = ({ task, onEditClick, onDeleteClick }) => {
  ...
  return (
    <div className="task flex justify-between gap-2 bg-background-input-light dark:bg-background-input-dark border-dark dark:border-none border rounded-lg text-light dark:text-dark px-3 py-2">
      <div>{task.title}</div>
        ...
        <div className="flex gap-2 items-center text-light dark:text-dark ">
          ...
          <div>
            <button 
              ...
              className="delete-task text-light dark:text-dark hover:text-red-500"
            >
